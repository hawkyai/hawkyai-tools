    ...
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        ...
        <div className="text-sm text-gray-400">
          ...
          <p>Analyzed on: {new Date(results.timestamp).toLocaleString()}</p>
        </div>
      </div>

      <div className="w-full py-8 px-0 overflow-x-hidden">
        <div className="flex flex-wrap items-center justify-between mb-8 gap-4">
          <Button variant="ghost" onClick={handleDownload} className="flex items-center gap-2 outline-button rounded-full text-white">
